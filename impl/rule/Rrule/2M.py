...
class Value2M(AbstractClueValue):
    ...
    def create_constraints(self, board: 'AbstractBoard'):
        ...
        if neighbor_vars:
            ...
            model.Add(neighbor_sum == self.count + 3).OnlyEnforceIf(b2)
            model.Add(neighbor_sum != self.count + 3).OnlyEnforceIf(b2.Not())

            model.Add(neighbor_sum == self.count + 6).OnlyEnforceIf(b3)
            model.Add(neighbor_sum != self.count + 6).OnlyEnforceIf(b3.Not())
